...
const SideBar = ({ handleNavBarClick }: Prop) => {
      ...
      <div className="frame-25">
        ...
        <div className="nav">
          <div className="top">
            ...
            <div
              className={walletSelected ? "sidebar-item" : "sidebar-item2"}
              onClick={wallet}
            >
              <div
                className={walletSelected ? "rectangle-306" : "rectangle-3062"}
              ></div>
              <div className="frame-2">
                <svg
                  className="icons3"
          ...
          <div onClick={signOut} className="sidebar-item2">
