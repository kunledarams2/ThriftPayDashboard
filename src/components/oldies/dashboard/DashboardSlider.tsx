      ...
      <div className="sidebar">
        ...
        <div className="user-account">
          <div className="group-105">
            <div className="frame-2">
              ...
              <div className="customers">Log Out </div>
            </div>
            {/* <img className="avatar" src="avatar.png" />
            <div className="name-position">
              <div className="eleanor-pena">Eleanor Pena </div>
            </div>
            <div className="name-position2">
            ...
            >
              <path
                d="M17.92 8.17993H11.69H6.07999C5.11999 8.17993 4.63999 9.33993 5.31999 10.0199L10.5 15.1999C11.33 16.0299 12.68 16.0299 13.51 15.1999L15.48 13.2299L18.69 10.0199C19.36 9.33993 18.88 8.17993 17.92 8.17993Z"
                fill="#FAFAFB"
              />
            </svg> */}
          </div>
        ...
        <div className="frame-25">
          ...
          <div className="frame-23">
            <div
              className={dashboardSelected ? "sidebar-item" : "sidebar-item2"}
              onClick={dashboard}
            >
              <div
                className={
                  dashboardSelected ? "rectangle-306" : "rectangle-3062"
                }
              ></div>
              <div className="frame-2">
                <svg
            ...
            <div
              className={thriftPlanSelected ? "sidebar-item" : "sidebar-item2"}
              onClick={thriftPlan}
            >
              <div
                className={
                  thriftPlanSelected ? "rectangle-306" : "rectangle-3062"
                }
              ></div>
              <div className="frame-2">
                <svg
