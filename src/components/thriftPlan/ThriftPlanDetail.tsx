...
import styles from "./ThriftPlanDetail.module.css";
import {
        ...
        <div className={styles.content}>
          ...
          <div className={styles.bannerParent}>
            {/* <div className={styles.banner}>
              <img
                className={styles.happyStudentcuateIcon}
                alt=""
                src="happy-student/cuate.svg"
              />
              <img className={styles.icons1} alt="" src="Icons.svg" />
              <div className={styles.bannerInner}>
                <div className={styles.februaryCycleCompletedSucceParent}>
                  <div className={styles.februaryCycleCompleted}>
                    🎉 February Cycle Completed Successfully! 🎉
                  </div>
                  <div className={styles.greatNewsThe}>
                    Great news! The February cycle for Basic Thrift Plan 1 has
            ...
            <div className={styles.frameParent}>
              <div className={styles.frameWrapper}>
                <div className={styles.frameGroup}>
                  <div className={styles.paymentDueDateParent}>
                    <div className={styles.paymentDueDate}>
                      <div className={styles.frameContainer}>
                        ...
                        <div
                          className={styles.totalAmountContributedForFWrapper}
                        >
                          <div className={styles.totalAmountContributed}>
                            Total Amount Contributed for{" "}
                      ...
                      <div className={styles.of50000Parent}>
                        <div className={styles.of50000}>
                          {getCurrency(
                            Number(thriftPlanActive?.ongoing_contribution) / 100
                          )}{" "}
                          of{" "}
                          {getCurrency(
                            Number(thriftPlanActive?.expented_contribution) /
                              100
                          )}{" "}
                        </div>
                    ...
                    <div className={styles.paymentDueDateGroup}>
                      <div className={styles.paymentDueDate1}>
                        <div className={styles.frameContainer}>
                          <div className={styles.container}>
                            <div className={styles.icon}>
                              <img
                          ...
                          <div className={styles.paymentDueDateContainer}>
                            <div className={styles.totalAmountContributed}>
                              Payment Due Date
                            </div>
                            <div className={styles.mar42023}>
                              {" "}
                              {moment(data.start_date)
                                .add(
                                  parentState.response?.data?.complete_month,
                          ...
                          <div className={styles.avatarsParent}>
                            ...
                            <div className={styles.johnDoeParent}>
                              <div className={styles.johnDoe}>
                                {thriftPlanActive?.payout_receiver.username}{" "}
                              </div>
                              <div className={styles.johndoeexamplecom}>
                                {thriftPlanActive?.payout_receiver.phone_number}
                              </div>
                            </div>
                            <div className={styles.bagde}>
                              <div className={styles.payOutReceived}>
                                Pay out Received
                              </div>
                            </div>
                          </div>
                    ...
                    <div className={styles.thriftMemberParent}>
                      {thriftPlanActive?.plan_member.map((result) => (
                        <div className={styles.thriftMember1}>
                          ...
                          {/* <div className={styles.bagde}>
                            <div className={styles.payOutReceived}>PAid</div>
                          </div> */}
                        </div>
                      ...
                      {/* <div className={styles.thriftMember}>
                        <div className={styles.avatarsGroup}>
                          ...
                          <div className={styles.johnDoeWrapper}>
                            <div className={styles.div}>John Doe</div>
                          </div>
                        </div>
                      ...
                      <div className={styles.thriftMember1}>
                        <div className={styles.avatarsGroup}>
                          ...
                          <div className={styles.johnDoeContainer}>
                            <div className={styles.div}>Frank Lampard</div>
                          </div>
                        </div>
                      ...
                      <div className={styles.thriftMember1}>
                        <div className={styles.avatarsGroup}>
                          <div className={styles.avatars1}>
                            <div className={styles.jd1}>JD</div>
                          </div>
                          <div className={styles.johnDoeContainer}>
                            <div className={styles.div}>Jane Doe</div>
                          </div>
                        </div>
                        <div className={styles.bagde2}>
                          <div className={styles.payOutReceived}>PAid</div>
                      ...
                      <div className={styles.thriftMember1}>
                        <div className={styles.avatarsGroup}>
                          ...
                          <div className={styles.johnDoeContainer}>
                            <div className={styles.div}>Ahmed Musa</div>
                          </div>
                        </div>
                        <div className={styles.bagde2}>
                          <div className={styles.payOutReceived}>PAid</div>
                      ...
                      <div className={styles.thriftMember1}>
                        <div className={styles.avatarsGroup}>
                          <div className={styles.avatars3}>
                            <div className={styles.jd1}>OJ</div>
                          </div>
                          <div className={styles.johnDoeContainer}>
                            <div className={styles.div}>Olawale Jumoke</div>
                          </div>
                        </div>
                        <div className={styles.bagde2}>
                          <div className={styles.payOutReceived}>PAid</div>
              ...
              <div className={styles.frameParent1}>
                  ...
                  {/* <div className={styles.pillsParent}>
                    <div className={styles.pills}>
                      <div className={styles.pillParent}>
                        <div className={styles.pill}>
                          <div className={styles.johnDoe}>All</div>
                        </div>
                    ...
                    <div className={styles.searchFieldParent}>
                      ...
                      <div className={styles.button}>
                        ...
                        <div className={styles.div}>Filters</div>
                      </div>
                    </div>
                  </div> */}
                </div>
                <div className={styles.headingParent}>
                  ...
                  <div className={styles.transactionsParent}>
                    <>
                      {thriftPlanActive?.contributions.length === 0 && (
                        <EmptyContainer
                      ...
                      {thriftPlanActive?.contributions.map((data) => (
                        <div className={styles.thriftplanCard}>
                          ...
                          <div className={styles.bankTransfer}>Wallet</div>
                          <div className={styles.n10000}>
                            +{getCurrency(Number(data.amount) / 100)}{" "}
                          </div>
                        </div>
